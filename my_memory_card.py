...
questions_list.append(Question('Национальна хижина якутов', 'Ураса', 'Юрта', 'Иглу', 'Хата'))
questions_list.append(Question('Лучшая игра года', 'Standoff 2 ', 'CS:GO', 'Симулятор Автомобиля 2 ', 'Fallguys',)
app = QApplication([])  
